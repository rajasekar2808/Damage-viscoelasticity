...
#######################################################################
#########  EXAMPLE 6: 3 POINT BENDING (Mode -1 fracture) ###########################
...
## load the mesh
basemeshname = 'beam_3_point_bending'     ## name of the mesh
meshid = ''
...
Yc = .014e6    ## critical energy release rate (J/m^3)
lc = 8e-3  ## characterstic/regularization length (m)
...
if not unilateral:
    ...
    law = visclaw.viscoElasticity2dPlaneStrain(ni,lamb,mu,tau,g1=g1,g2=g2,Yc=Yc,h=H)
else:
